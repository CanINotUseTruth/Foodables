...
public class ModBlocks {
    ...
    public static void registerBlocks() {
        ...
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "jungle_drying_rack"), JUNGLE_DRYING_RACK);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "dark_oak_drying_rack"), DARK_OAK_DRYING_RACK);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "acacia_drying_rack"), ACACIA_DRYING_RACK);
        ...
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "apple_cake"), APPLE_CAKE);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "berry_cake"), BERRY_CAKE);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "orange_cake"), ORANGE_CAKE);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "banana_cake"), BANANA_CAKE);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "chocolate_cake"), CHOCOLATE_CAKE);

        // Generated Blocks
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "salt_ore"), SALT_ORE);

        // Tree Blocks
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "peppercorn_leaves"), PEPPERCORN_LEAVES);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "peppercorn_sapling"), PEPPERCORN_SAPLING);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "potted_peppercorn_sapling"), POTTED_PEPPERCORN_SAPLING);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "lemon_leaves"), LEMON_LEAVES);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "lemon_sapling"), LEMON_SAPLING);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "potted_lemon_sapling"), POTTED_LEMON_SAPLING);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "lime_leaves"), LIME_LEAVES);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "lime_sapling"), LIME_SAPLING);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "potted_lime_sapling"), POTTED_LIME_SAPLING);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "orange_leaves"), ORANGE_LEAVES);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "orange_sapling"), ORANGE_SAPLING);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "potted_orange_sapling"), POTTED_ORANGE_SAPLING);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "apple_leaves"), APPLE_LEAVES);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "apple_sapling"), APPLE_SAPLING);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "potted_apple_sapling"), POTTED_APPLE_SAPLING);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "mango_leaves"), MANGO_LEAVES);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "mango_sapling"), MANGO_SAPLING);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "potted_mango_sapling"), POTTED_MANGO_SAPLING);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "banana_leaves"), BANANA_LEAVES);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "banana_sapling"), BANANA_SAPLING);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "potted_banana_sapling"), POTTED_BANANA_SAPLING);

        // Berry Blocks
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "blueberry_bush"), BLUEBERRY_BUSH);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "blackberry_bush"), BLACKBERRY_BUSH);

        // Crop Blocks
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "lettuce_crop"), LETTUCE_CROP);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "tomato_crop"), TOMATO_CROP);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "brown_onion_crop"), BROWN_ONION_CROP);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "red_onion_crop"), RED_ONION_CROP);
        Registry.register(Registries.BLOCK, new Identifier(Foodables.MOD_ID, "garlic_crop"), GARLIC_CROP);
    }
