...
public class OakDryingRack extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public OakDryingRack(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new OakDryingRackEntity(pos, state);
    }
    
    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlocks.OAK_DRYING_RACK_ENTITY, world.isClient ? OakDryingRackEntity::clientTick : OakDryingRackEntity::serverTick);
    }
    
    @Override
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand,
        BlockHitResult hit) {
        OakDryingRackEntity dryingRackEntity = (OakDryingRackEntity) world.getBlockEntity(pos);
