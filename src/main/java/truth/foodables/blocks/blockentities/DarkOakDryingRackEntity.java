...
public class DarkOakDryingRackEntity extends BlockEntity implements Inventory, BlockEntityClientSerializable{
    ...
    public DarkOakDryingRackEntity(BlockPos pos, BlockState state) {
        super(ModBlocks.DARK_OAK_DRYING_RACK_ENTITY, pos, state);
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, DarkOakDryingRackEntity blockEntity) {
        blockEntity.update();
    }

    public static void serverTick(World world, BlockPos pos, BlockState state, DarkOakDryingRackEntity blockEntity) {
        blockEntity.update();
    }
