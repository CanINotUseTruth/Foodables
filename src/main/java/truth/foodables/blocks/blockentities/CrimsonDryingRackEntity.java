...
public class CrimsonDryingRackEntity extends BlockEntity implements Inventory, BlockEntityClientSerializable{
    ...
    public CrimsonDryingRackEntity(BlockPos pos, BlockState state) {
        super(ModBlocks.CRIMSON_DRYING_RACK_ENTITY, pos, state);
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, CrimsonDryingRackEntity blockEntity) {
        blockEntity.update();
    }

    public static void serverTick(World world, BlockPos pos, BlockState state, CrimsonDryingRackEntity blockEntity) {
        blockEntity.update();
    }
