...
public class SpruceDryingRackEntity extends BlockEntity implements Inventory, BlockEntityClientSerializable{
    ...
    public SpruceDryingRackEntity(BlockPos pos, BlockState state) {
        super(ModBlocks.SPRUCE_DRYING_RACK_ENTITY, pos, state);
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, SpruceDryingRackEntity blockEntity) {
        blockEntity.update();
    }

    public static void serverTick(World world, BlockPos pos, BlockState state, SpruceDryingRackEntity blockEntity) {
        blockEntity.update();
    }
