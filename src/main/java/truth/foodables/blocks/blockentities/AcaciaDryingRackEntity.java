...
public class AcaciaDryingRackEntity extends BlockEntity implements Inventory, BlockEntityClientSerializable{
    ...
    public AcaciaDryingRackEntity(BlockPos pos, BlockState state) {
        super(ModBlocks.ACACIA_DRYING_RACK_ENTITY, pos, state);
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, AcaciaDryingRackEntity blockEntity) {
        blockEntity.update();
    }

    public static void serverTick(World world, BlockPos pos, BlockState state, AcaciaDryingRackEntity blockEntity) {
        blockEntity.update();
    }
