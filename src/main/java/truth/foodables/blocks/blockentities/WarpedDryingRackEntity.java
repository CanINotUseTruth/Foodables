...
public class WarpedDryingRackEntity extends BlockEntity implements Inventory, BlockEntityClientSerializable{
    ...
    public WarpedDryingRackEntity(BlockPos pos, BlockState state) {
        super(ModBlocks.WARPED_DRYING_RACK_ENTITY, pos, state);
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, WarpedDryingRackEntity blockEntity) {
        blockEntity.update();
    }

    public static void serverTick(World world, BlockPos pos, BlockState state, WarpedDryingRackEntity blockEntity) {
        blockEntity.update();
    }
