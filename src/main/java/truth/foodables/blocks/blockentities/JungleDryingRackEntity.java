...
public class JungleDryingRackEntity extends BlockEntity implements Inventory, BlockEntityClientSerializable{
    ...
    public JungleDryingRackEntity(BlockPos pos, BlockState state) {
        super(ModBlocks.JUNGLE_DRYING_RACK_ENTITY, pos, state);
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, JungleDryingRackEntity blockEntity) {
        blockEntity.update();
    }

    public static void serverTick(World world, BlockPos pos, BlockState state, JungleDryingRackEntity blockEntity) {
        blockEntity.update();
    }
