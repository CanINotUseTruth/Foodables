...
public class OakDryingRackEntity extends BlockEntity implements Inventory, BlockEntityClientSerializable{
    ...
    public OakDryingRackEntity(BlockPos pos, BlockState state) {
        super(ModBlocks.OAK_DRYING_RACK_ENTITY, pos, state);
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, OakDryingRackEntity blockEntity) {
        blockEntity.update();
    }

    public static void serverTick(World world, BlockPos pos, BlockState state, OakDryingRackEntity blockEntity) {
        blockEntity.update();
    }
