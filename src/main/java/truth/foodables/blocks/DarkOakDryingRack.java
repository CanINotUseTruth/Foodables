...
public class DarkOakDryingRack extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public DarkOakDryingRack(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new DarkOakDryingRackEntity(pos, state);
    }
    
    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlocks.DARK_OAK_DRYING_RACK_ENTITY, world.isClient ? DarkOakDryingRackEntity::clientTick : DarkOakDryingRackEntity::serverTick);
    }
    
    @Override
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand,
        BlockHitResult hit) {
        DarkOakDryingRackEntity dryingRackEntity = (DarkOakDryingRackEntity) world.getBlockEntity(pos);
