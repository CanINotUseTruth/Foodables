...
public class BirchDryingRack extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public BirchDryingRack(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new BirchDryingRackEntity(pos, state);
    }
    
    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlocks.BIRCH_DRYING_RACK_ENTITY, world.isClient ? BirchDryingRackEntity::clientTick : BirchDryingRackEntity::serverTick);
    }
    
    @Override
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand,
        BlockHitResult hit) {
        BirchDryingRackEntity dryingRackEntity = (BirchDryingRackEntity) world.getBlockEntity(pos);
