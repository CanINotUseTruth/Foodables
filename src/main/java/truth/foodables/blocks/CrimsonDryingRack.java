...
public class CrimsonDryingRack extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public CrimsonDryingRack(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new CrimsonDryingRackEntity(pos, state);
    }
    
    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlocks.CRIMSON_DRYING_RACK_ENTITY, world.isClient ? CrimsonDryingRackEntity::clientTick : CrimsonDryingRackEntity::serverTick);
    }
    
    @Override
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand,
        BlockHitResult hit) {
        CrimsonDryingRackEntity dryingRackEntity = (CrimsonDryingRackEntity) world.getBlockEntity(pos);
