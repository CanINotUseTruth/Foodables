...
public class AcaciaDryingRack extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public AcaciaDryingRack(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new AcaciaDryingRackEntity(pos, state);
    }
    
    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlocks.ACACIA_DRYING_RACK_ENTITY, world.isClient ? AcaciaDryingRackEntity::clientTick : AcaciaDryingRackEntity::serverTick);
    }
    
    @Override
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand,
        BlockHitResult hit) {
        AcaciaDryingRackEntity dryingRackEntity = (AcaciaDryingRackEntity) world.getBlockEntity(pos);
