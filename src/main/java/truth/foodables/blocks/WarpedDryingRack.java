...
public class WarpedDryingRack extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public WarpedDryingRack(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new WarpedDryingRackEntity(pos, state);
    }
    
    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlocks.WARPED_DRYING_RACK_ENTITY, world.isClient ? WarpedDryingRackEntity::clientTick : WarpedDryingRackEntity::serverTick);
    }
    
    @Override
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand,
        BlockHitResult hit) {
        WarpedDryingRackEntity dryingRackEntity = (WarpedDryingRackEntity) world.getBlockEntity(pos);
