...
public class JungleDryingRack extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public JungleDryingRack(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new JungleDryingRackEntity(pos, state);
    }
    
    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlocks.JUNGLE_DRYING_RACK_ENTITY, world.isClient ? JungleDryingRackEntity::clientTick : JungleDryingRackEntity::serverTick);
    }
    
    @Override
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand,
        BlockHitResult hit) {
        JungleDryingRackEntity dryingRackEntity = (JungleDryingRackEntity) world.getBlockEntity(pos);
